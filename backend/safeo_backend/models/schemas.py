...
class SimulationResult(BaseModel):
    ...
    decision: str
    explanation: str
    generic_waf_caught: Optional[bool] = None   # would a regex-only WAF catch this?
    script: Optional[str] = None                # "arabic" | "arabizi" | "mixed" | "latin"
...
class SimulateResponse(BaseModel):
    ...
    generic_waf_rate: Optional[float] = None    # comparison rate for WAF


class ArabiziStage(BaseModel):
    raw: str
    normalised: str
    patterns_matched: List[str]
    decision: str
    risk_score: float
    generic_waf_caught: bool


class ArabiziDemoResponse(BaseModel):
    samples: List[ArabiziStage]
    summary: str
